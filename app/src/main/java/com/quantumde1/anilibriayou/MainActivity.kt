        ...
        setContent {
            ...
            Scaffold(
                ...
                NavHost(
                    ...
                    composable("profile") { HomeScreen(navController) } // Specify the fixed id here
                    ...
                    composable("episodesList/{animeId}") { backStackEntry ->
                        EpisodesList(
                            ...
                            animeId = backStackEntry.arguments?.getString("animeId")?.toIntOrNull() ?: -1, // Use -1 or another invalid ID as the default
                            uri = backStackEntry.arguments?.getString("uri") ?: "" // Use an empty string as the default
                        )
                    }
